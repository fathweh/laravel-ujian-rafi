...
<head>
    ...
    <title>Sepatu Bekas Store - Dashboard</title>
...
<body id="page-top">
                    ...
                    <form action="{{route('merk.update', $merk->id)}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nama_merk') is-invalid @enderror"
                                   name="nama_merk" value="{{$merk->nama_merk}}">
                            @error('nama_merk')
                        ...
                        <div class="mb-3">
                            ...
                            @if ($merk->foto)
                                <div class="mb-2">
                                    <img src="{{ Storage::url('merk/' . $merk->foto) }}" alt="Foto merk" 
                                         class="img-thumbnail" width="150">
                                </div>
                            @endif
                            <input type="file" class="form-control @error('foto') is-invalid @enderror" 
                                   name="foto" value="{{$merk->foto}}">
                            @error('foto')
                                <div class="invalid-feedback">{{$message}}</div>
                            @enderror
                        </div>
    ...
    admin/js/demo/chart-pie-demo.js')}}"></script>
